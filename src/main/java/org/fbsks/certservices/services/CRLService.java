...
public class CRLService {
	...
	public X509CRL generateCRL(String caName) {
		try {		
			...
			crlGenerator.setIssuerDN(new X500Principal(ca.getIdentityContainer().getCertificate().getSubject().toString()));
			...
			crlGenerator.addExtension(X509Extensions.AuthorityKeyIdentifier, false, new AuthorityKeyIdentifierStructure(caCertificate));
